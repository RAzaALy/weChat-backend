...
Before running the application, make sure to set up your environment variables. Create a `.env` file in the root directory of your project, if it doesn't already exist. Then, add the following line to it:
 PORT=8000
URL=mongodb+srv://raza:password@cluster0.hkghnes.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0
SECRET='secret'
CLIENT_ID=
